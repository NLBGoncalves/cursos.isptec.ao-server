...
exports.createOrder = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        if (payment_info) {
            if ("id" in payment_info) {
                ...
                if (paymentIntent.status !== "succeeded") {
                    return next(new ErrorHandler_1.default("Pagamento não autorizado!", 400));
                }
            }
        }
        ...
        if (courseExistInUser) {
            return next(new ErrorHandler_1.default("Você já comprou este curso", 400));
        }
